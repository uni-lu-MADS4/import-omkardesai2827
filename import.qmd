...
> Tibbles give some extra information like summary of data without explicitly writing a code to get that. 
Rows: 25 Columns: 5
...
```{r}
read_delim("data/blood_fat.csv",col_types = cols(age="i",
                                                 id="i"))
